...
\solution The input parameters for this construction are available in TABLE 1.1.1.
...
\centering
 \begin{align}
  ...
  $Consider \triangle OQ2P$,\\
   ...
   OP = 7 and OQ2 = 4\\
   \Rightarrow $PQ2$ = $\surd{33}$

 \end{align}
\textbf{Therefore, the length of tangent is $\surd 33$.}
